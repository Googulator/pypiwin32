...
def BrandProject(vssProjectName, descFile, stampPath,
                 filesToSubstitute, buildDesc=None, auto=0, bRebrand=0):
    ...
    # stampPath -- The full path to where the files referenced in descFile can
    # be found.
