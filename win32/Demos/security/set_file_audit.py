...
# SE_SECURITY_NAME needed to access SACL, SE_RESTORE_NAME needed to change
# owner to someone other than yourself
new_privs = (
...
# create a dir and set security so Everyone has read permissions, and all
# files and subdirs inherit its ACLs
...
dir_dacl.AddAccessAllowedAceEx(
    ...
    my_sid)
# keep dir from inheriting any permissions so it only has ACEs explicitely
# set here
