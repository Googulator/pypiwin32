...
if dacl is None:
    ...
    for ace_no in range(0, dacl.GetAceCount()):
        ...
        if os.path.isfile(name):
            ...
            # directories also contain an ACE that is inherited by children
            # (files) within them
            if ace[0][1] & ntsecuritycon.OBJECT_INHERIT_ACE == ntsecuritycon.OBJECT_INHERIT_ACE and ace[
                    0][1] & ntsecuritycon.INHERIT_ONLY_ACE == ntsecuritycon.INHERIT_ONLY_ACE:
