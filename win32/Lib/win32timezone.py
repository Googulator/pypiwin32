...
class TimeZoneInfo(datetime.tzinfo):
    ...
    def get_all_time_zones():
        return [TimeZoneInfo(n)
                for n in TimeZoneInfo._get_time_zone_key_names()]
...
GetTimeZoneNames = deprecated(
    TimeZoneInfo._get_time_zone_key_names,
    'GetTimeZoneNames')
GetIndexedTimeZoneNames = deprecated(
    TimeZoneInfo._get_indexed_time_zone_keys,
    'GetIndexedTimeZoneNames')
GetSortedTimeZoneNames = deprecated(
...
def GetTZCapabilities():
    ...
    MissingTZPatch = datetime.datetime(
        2007, 11, 2, tzinfo=tzi).utctimetuple() != (
        2007, 11, 2, 6, 0, 0, 4, 306, 0)
    DynamicTZSupport = not MissingTZPatch and datetime.datetime(
        2003, 11, 2, tzinfo=tzi).utctimetuple() == (
