...
class BaseQuery:
    ...
    def rawaddcounter(self, object, counter, instance=None,
                      inum=-1, machine=None):
        '''
    ...
    def collectdataslave(self, format=win32pdh.PDH_FMT_LONG):
        ...
        try:
            ...
            return temp
        # will happen if, for instance, no counters are part of the query and
        # we attempt to collect data for it.
        except win32api.error:
...
class Query(BaseQuery):
    ...
    def getinstpaths(self, object, counter, machine=None,
                     objtype='Process', format=win32pdh.PDH_FMT_LONG):
        '''
    ...
    def open(self, *args, **namedargs):
        ...
        for path in paths:
            try:
                ...
                # if we fail on the line above, this path won't be in the table
                # or the counters
