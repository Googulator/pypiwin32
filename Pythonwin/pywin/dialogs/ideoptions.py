    ...
    def OnInitDialog(self):
        ...
        format = eval(
            win32ui.GetProfileVal(
                interact.sectionProfile, interact.STYLE_INTERACTIVE_PROMPT, str(
                    interact.formatInput)))
        ...
        format = eval(
            win32ui.GetProfileVal(
                interact.sectionProfile, interact.STYLE_INTERACTIVE_OUTPUT, str(
                    interact.formatOutput)))
        edit.SetDefaultCharFormat(format)
        ...
        format = eval(
            win32ui.GetProfileVal(
                interact.sectionProfile, interact.STYLE_INTERACTIVE_ERROR, str(
                    interact.formatOutputError)))
        edit.SetDefaultCharFormat(format)
