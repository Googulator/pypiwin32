...
class ScintillaFormatPropertyPage(dialog.PropertyPage):
    ...
    def OnInitDialog(self):
        try:
            ...
            self.HookCommand(
                self.OnButUseDefaultBackground,
                win32ui.IDC_CHECK2)
    ...
    def UpdateUIForStyle(self, style):
        ...
        self.GetDlgItem(
            win32ui.IDC_BUTTON3).EnableWindow(
    ...
    def ApplyUIFormatToStyle(self, style):
        ...
        maskFlags = format[
            0] | win32con.CFM_COLOR | win32con.CFM_BOLD | win32con.CFM_ITALIC
        style.format = (maskFlags, effect, style.format[
                        2], style.format[3], color[1]) + style.format[5:]
