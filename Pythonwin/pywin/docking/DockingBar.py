...
class DockingBar(window.Wnd):
    ...
    def CreateWindow(
        ...
        self._obj_.CreateWindow(
            wndClass, title, style, (0, 0, 0, 0), parent, id)
        ...
        self.sizeHorz = self.sizeVert = self.sizeFloat = rect[
            2] - rect[0], rect[3] - rect[1]

        self.sizeHorz = self.sizeHorz[0], self.sizeHorz[
            1] + self.cxEdge + self.cxBorder
    ...
    def CalcDynamicLayout(self, length, mode):
        ...
        if self.IsFloating():
            ...
            if hittest == win32con.HTTOPLEFT:
                ...
                cy = max(
                    windowRect[3] - self.cCaptionSize - pt[1],
                    self.cMinHeight) - 1
                ...
                dc.rectFrameDragHorz = left, top, dc.rectFrameDragHorz[
                    2], dc.rectFrameDragHorz[3]
                return self.sizeFloat
...
#	def OnBarStyleChange(self, old, new):
    ...
    def OnNcCalcSize(self, bCalcValid, size_info):
        ...
        if self.nDockBarID == afxres.AFX_IDW_DOCKBAR_TOP:
            ...
            self.rectBorder = self.rectBorder[0], self.rectBorder[
                3] - self.cxEdge, self.rectBorder[2], self.rectBorder[3]
            ...
            rc0.right = rc0.right - self.cxBorder
            self.rectBorder = self.rectBorder[0], self.rectBorder[
                1], self.rectBorder[2], self.rectBorder[1] + self.cxEdge
            ...
            self.rectBorder = self.rectBorder[
                2] - self.cxEdge, self.rectBorder[1], self.rectBorder[2], self.rectBorder[3]
            ...
            rc0.top = rc0.top + self.cxGripper
            self.rectBorder = self.rectBorder[0], self.rectBorder[
                1], self.rectBorder[0] + self.cxEdge, self.rectBorder[3]
        else:
