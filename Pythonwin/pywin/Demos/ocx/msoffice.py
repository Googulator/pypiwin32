...
# raise ImportError, "Microsoft Word version 8 does not appear to be
# installed."
...
class ExcelView(docview.ScrollView):
    ...
    def OnSetFocus(self, msg):
        ...
        if item is not None and item.GetItemState(
...
class OleTemplate(docview.DocTemplate):
    ...
    def __init__(self, resourceId=None, MakeDocument=None,
                 MakeFrame=None, MakeView=None):
