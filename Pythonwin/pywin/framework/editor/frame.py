...
class EditorFrame(pywin.framework.window.MDIChildWnd):
    ...
    def OnCreateClient(self, cp, context):
        ...
        # Create the default view as specified by the template (ie, the editor
        # view)
        ...
        # Note we must add the default view first, so that doc.GetFirstView()
...
##        splitter.CreateView (browserView, 0, 0, (0, 0))
    ...
    def OnClose(self):
        ...
        # Must force the module browser to close itself here (OnDestroy for the
        # view itself is too late!)
