...
class EditorPropertyPage(dialog.PropertyPage):
    ...
    def __init__(self):
        ...
        self._AddEditorOption(
            win32ui.IDC_FOLD_SHOW_LINES, "i", "Fold Lines", 1)
    ...
    def _AddEditorOption(self, idd, typ, optionName, defaultVal):
        ...
        # So we don't actually store these values, but they do still get DDX
        # support.
    ...
    def OnInitDialog(self):
        ...
        for spinner_id in (win32ui.IDC_SPIN1,
                           win32ui.IDC_SPIN2, win32ui.IDC_SPIN3):
    ...
    def OnOK(self):
        ...
        if self['bVSS']:
            ...
            if GetEditorOption("Source Control Module",
                               "") == 'pywin.framework.editor.vss':
...
class EditorWhitespacePropertyPage(dialog.PropertyPage):
    ...
    def OnOK(self):
        ...
        SetEditorOption(
            "Use Tabs", self.GetDlgItem(
                win32ui.IDC_USE_TABS).GetCheck())

        SetEditorOption(
            "Use Tab Timmy", self.GetDlgItem(
