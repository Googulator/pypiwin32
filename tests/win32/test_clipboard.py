...
class TestBitmap(unittest.TestCase):
    ...
    def test_bitmap_roundtrip(self):
        ...
        try:
            ...
            assert got_handle == self.bmp_handle
        finally:
            CloseClipboard()
...
class TestStrings(unittest.TestCase):
    ...
    def test_unicode(self):
        ...
        assert GetClipboardData(win32con.CF_UNICODETEXT) == val
    ...
    def test_unicode_text(self):
        ...
        assert GetClipboardData(win32con.CF_TEXT) == expected
    ...
    def test_string(self):
        ...
        assert GetClipboardData(win32con.CF_TEXT) == val
...
class TestGlobalMemory(unittest.TestCase):
    ...
    def test_custom_mem(self):
        ...
        assert custom_format_name == GetClipboardFormatName(cf)
