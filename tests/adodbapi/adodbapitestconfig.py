...
# function to clean up the temporary folder -- calling program must run
# this function before exit.
...
if doAccessTest:
    ...
    # macro definition for keyword "driver"  using macro "is64bit" -- see
    # documentation
    c['macro_is64bit'] = [
        'driver',
