...
class ADOEvents:  # event handler class
    ...
    def OnBeginTransComplete(self, TransactionLevel,
    ...
    def OnExecuteComplete(self, RecordsAffected, pError,
                          adStatus, pCommand, pRecordset, pConnection):
        pass

    def OnWillExecute(self, Source, CursorType, LockType,
                      Options, adStatus, pCommand, pRecordset, pConnection):
        pass
