...
def RegisterPythonServer(filename, progids=None, verbose=0):
    if progids:
        ...
        for progid in progids:
            ...
            # print "Skipping registration of '%s' - already registered" %
            # filename
            return
...
class _CapturingFunctionTestCase(
    unittest.FunctionTestCase):  # , TestCaseMixin):
    ...
    def __call__(self, result=None):
        ...
        try:
            ...
            if getattr(self, "do_leak_tests", 0) and hasattr(
