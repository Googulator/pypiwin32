...
class TypeBrowseDialog(TypeBrowseDialog_Parent):
    ...
    def _GetMainInfoTypes(self):
        ...
        try:
            infos.append(
                ('Type Kind', typekindmap[
                    self.tlb.GetTypeInfoType(pos)]))
        except:
            pass
    ...
    def GetTemplate(self):
        ...
        template.append([131, None, self.IDC_TYPELIST,
                         (10, 20, 80, 80), LBS_STD])
        template.append([130, "&Members", -
                         1, (100, 10, 62, 9), SS_STD | win32con.SS_LEFT])
        template.append([131, None, self.IDC_MEMBERLIST,
                         (100, 20, 80, 80), LBS_STD])
        template.append([130, "&Parameters", -
                         1, (190, 10, 62, 9), SS_STD | win32con.SS_LEFT])
