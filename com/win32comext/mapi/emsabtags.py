...
from .mapitags import PT_LONG, PT_BOOLEAN, PT_OBJECT, PT_STRING8, PT_UNICODE, \
    PT_SYSTIME, PT_BINARY, PT_TSTRING, \
    PT_MV_LONG, PT_MV_STRING8, PT_MV_BINARY, PT_MV_UNICODE, \
    PT_MV_TSTRING, \
    PROP_TAG
