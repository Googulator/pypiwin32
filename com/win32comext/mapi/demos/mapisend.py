...
# you can test this by changing the variables at the bottom and running
...
def SendEMAPIMail(Subject="", Message="", SendTo=None,
                  SendCC=None, SendBCC=None, MAPIProfile=None):
