...
class SecurityInformation(win32com.server.policy.DesignatedWrapPolicy):
    ...
    def GetSecurity(self, requestedinfo, bdefault):
        ...
        if bdefault:
            ...
            # should cause inherited ACL from parent dir or default dacl from
            # user's token to be used
            return win32security.SECURITY_DESCRIPTOR()
        else:
            # GetFileSecurity sometimes fails to return flags indicating that
            # an ACE is inherited
    ...
    def GetAccessRights(self, objecttype, flags):
        ...
        """
        # input flags: SI_ADVANCED,SI_EDIT_AUDITS,SI_EDIT_PROPERTIES indicating
        # which property sheet is requesting the rights
    ...
    def EditSecurity(self, owner_hwnd=0):
        ...
        isi = pythoncom.WrapObject(
            self,
            authorization.IID_ISecurityInformation,
