...
# None is only valid for local system acct or if task flags contain
...
tt = tr.GetTrigger()
# flags for a new trigger default to TASK_TRIGGER_FLAG_DISABLED (4), make
# sure to clear them if not using any
tt.Flags = 0
